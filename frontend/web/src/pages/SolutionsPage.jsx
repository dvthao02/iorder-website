...
export default function SolutionsPage() {
  ...
  useEffect(() => {
    setPageSeo({
      ...
      description:
        'Các giải pháp hạ tầng mạng, Wifi, camera, bảo mật, data center, server và kiểm soát ra vào dành cho doanh nghiệp.',
    })
  }, [])
      ...
      <section className="listing-hero solution-hero">
        <div className="container software-hero-grid">
          ...
          <div className="software-hero-panel">
            ...
            {[
              'Khảo sát hiện trạng',
              'Thiết kế sơ đồ và cấu hình',
              'Thi công, kiểm thử thiết bị',
              'Bàn giao tài liệu và bảo trì',
            ].map((item, index) => (
