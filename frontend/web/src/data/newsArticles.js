...
export const newsArticles = [
  {
    ...
    excerpt:
      'Order tại bàn giúp nhà hàng giảm thời gian chờ, hạn chế sai sót khi ghi món và đồng bộ đơn hàng tới thu ngân, bếp/bar nhanh hơn.',
    ...
    checklist: [
      'Có order tại bàn theo từng bàn/phòng không?',
      'Đơn có chuyển nhanh tới bếp/bar không?',
      'Bill có cập nhật theo thời gian thực không?',
      'Có in hóa đơn và hỗ trợ thanh toán online không?',
    ],
  },
  {
    id: 2,
    ...
    excerpt:
      'iOrder giúp chủ cửa hàng theo dõi nhập xuất tồn, cảnh báo hàng sắp hết và kiểm tra lệch kho theo từng chi nhánh.',
    ...
    checklist: [
      'Có theo dõi tồn theo chi nhánh không?',
      'Có lịch sử nhập xuất rõ ràng không?',
      'Có cảnh báo hàng sắp hết không?',
      'Có kiểm được sản phẩm bán chậm không?',
    ],
  },
  {
    id: 3,
    ...
    checklist: [
      'Có sơ đồ bàn/phòng không?',
      'Có in bếp và in bar riêng không?',
      'Có tách/gộp/chuyển bàn không?',
      'Có xem món bán chạy theo ngày không?',
    ],
  },
  {
    id: 4,
    ...
    excerpt:
      'Doanh thu theo ngày, ca, nhân viên, chi nhánh và sản phẩm bán chạy là dữ liệu nền để ra quyết định nhanh hơn.',
    ...
    checklist: [
      'Có xem doanh thu theo ca không?',
      'Có tách tiền mặt và chuyển khoản không?',
      'Có biết sản phẩm bán chạy không?',
      'Có so sánh chi nhánh được không?',
    ],
  },
  {
    id: 5,
    ...
    excerpt:
      'Danh mục sản phẩm, bảng giá, thiết bị bán hàng, tài khoản nhân viên và quy trình ca là những phần nên chuẩn bị trước.',
    category: 'Triển khai',
    date: '2026-05-30',
    ...
    checklist: [
      'Đã có danh mục sản phẩm chưa?',
      'Đã kiểm tra máy in và mã vạch chưa?',
      'Đã tạo tài khoản nhân viên chưa?',
      'Đã thống nhất quy trình chốt ca chưa?',
    ],
  },
  {
    id: 6,
    ...
    excerpt:
      'iOrder phục vụ cửa hàng bán lẻ, cafe, nhà hàng, trà sữa, mini mart và chuỗi cần quản lý dữ liệu tập trung.',
    ...
    checklist: [
      'Cửa hàng có cần bán nhanh tại quầy không?',
      'Có cần quản lý tồn kho không?',
      'Có nhiều nhân viên hoặc chi nhánh không?',
      'Có cần xem báo cáo từ xa không?',
    ],
  },
]
