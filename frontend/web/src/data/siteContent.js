...
export const softwareProducts = [
  {
    ...
    // REMOVE-BY: 2026-12-31 — quản trị bộ nội dung này trong CMS Offering Sections.
    features: [
      { workflow: 'setup', icon: 'catalog', title: 'Sản phẩm, giá và khuyến mãi', description: 'Quản lý danh mục, giá bán, mã vạch và chính sách ưu đãi.' },
      { workflow: 'setup', icon: 'staff', title: 'Nhân viên và phân quyền', description: 'Thiết lập vai trò, giới hạn thao tác và theo dõi vận hành theo ca.' },
      { workflow: 'setup', icon: 'settings', title: 'Quy trình bán hàng và thiết lập', description: 'Cấu hình luồng bán hàng, thanh toán, chi nhánh và các quy tắc vận hành.' },
      { workflow: 'inventory', icon: 'inventory', title: 'Kho và nhập xuất', description: 'Kiểm soát tồn kho, lịch sử nhập xuất và hàng hóa theo điểm bán.' },
      { workflow: 'inventory', icon: 'devices', title: 'Thiết bị và in ấn', description: 'Kết nối máy in, máy quét mã vạch và các thiết bị POS phù hợp.' },
      { workflow: 'sales', icon: 'sales', title: 'Bán hàng và đơn hàng', description: 'Tạo đơn tại quầy, gọi món, tách/gộp hóa đơn và xử lý thanh toán.' },
      { workflow: 'sales', icon: 'tables', title: 'Quản lý bàn và gọi món', description: 'Theo dõi sơ đồ bàn, trạng thái phục vụ và các món theo đơn.' },
      { workflow: 'settlement', icon: 'invoice', title: 'Hóa đơn điện tử', description: 'Phát hành, tra cứu và quản lý hóa đơn theo quy trình bán hàng.' },
      { workflow: 'settlement', icon: 'cashflow', title: 'Thu chi và chốt ca', description: 'Ghi nhận dòng tiền, đối soát ca bán hàng và kiểm soát quỹ rõ ràng.' },
      { workflow: 'growth', icon: 'customers', title: 'Khách hàng và thành viên', description: 'Lưu thông tin, lịch sử mua hàng và chăm sóc khách hàng thuận tiện.' },
      { workflow: 'growth', icon: 'reporting', title: 'Báo cáo vận hành', description: 'Theo dõi doanh thu, đơn hàng, tồn kho và hiệu quả theo thời gian.' },
      { workflow: 'growth', icon: 'integrations', title: 'Tích hợp và đồng bộ', description: 'Đồng bộ dữ liệu với các hệ thống, thiết bị và dịch vụ cần thiết.' },
    ],
    benefits: [
  ...
  },
  {
    ...
    faq: [
      [
        'RPA có thay thế tích hợp API không?',
        'Không nhất thiết. RPA phù hợp khi hệ thống cần tự động hóa thao tác hoặc chưa có API đầy đủ.',
      ],
      [
        'Có đồng bộ theo lịch được không?',
        'Có thể cấu hình theo lịch, theo sự kiện hoặc theo quy trình vận hành cụ thể.',
      ],
      [
        'Cần chuẩn bị gì trước khi triển khai?',
        'Cần mô tả nguồn dữ liệu, tài khoản truy cập, quy tắc đồng bộ và kịch bản kiểm thử.',
      ],
    ],
  },
  {
    ...
    faq: [
      [
        'Có xem trạng thái thiết bị được không?',
        'Có thể thiết kế màn hình giám sát theo loại thiết bị và giao thức tích hợp.',
      ],
  ...
  },
  {
    ...
    faq: [
      ...
      [
        'Có theo dõi chi phí chuyến không?',
        'Có thể ghi nhận chi phí nhiên liệu, bảo trì và phát sinh theo từng chuyến.',
      ],
  ...
  },
  {
    ...
    features: [
      ...
      'Hỗ trợ xử lý lỗi công cụ ký số khi vận hành',
      'Tư vấn quy trình chứng từ phù hợp cửa hàng và doanh nghiệp',
    ],
    benefits: [
      'Tiết kiệm thời gian xử lý chứng từ',
      'Dễ tra cứu và bàn giao kế toán',
      'Giảm sai sót khi phát hành hóa đơn',
      'Có đội hỗ trợ khi cần cài đặt',
    ],
    faq: [
...
export const solutionPages = [
  ...
  },
  {
    ...
    features: [
      ...
      'Theo dõi log, cảnh báo và đề xuất bảo trì',
    ],
  },
  {
    slug: 'data-center',
    ...
    features: [
      ...
      'Phân quyền truy cập và kiểm soát dữ liệu',
      'Tài liệu hóa hạ tầng để bảo trì lâu dài',
    ],
  },
  {
    slug: 'may-chu-server',
    ...
    features: [
      ...
      'Backup, giám sát log và cảnh báo dung lượng',
      'Bàn giao thông tin quản trị và tài liệu vận hành',
    ],
  },
  {
    ...
    features: [
      ...
      'Bàn giao hướng dẫn sử dụng và bảo trì thiết bị',
    ],
  },
]
...
export const servicePages = [
  ...
  },
  {
    ...
    features: [
      ...
      'Hỗ trợ xử lý lỗi chứng từ điện tử ban đầu',
    ],
  },
  {
