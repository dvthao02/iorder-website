...
const pages = {
  '/phan-mem/quan-ly-ban-hang-iorder': {
    ...
    sections: [
      { title: 'Tính năng nổi bật', items: ['Bán hàng tại quầy', 'Quản lý kho', 'In hóa đơn và in bếp', 'Phân quyền nhân viên', 'Báo cáo doanh thu'] },
  ...
  '/phan-mem/quan-ly-truong-mam-non-mimiedu': {
    ...
    sections: [
      { title: 'Nghiệp vụ trường học', items: ['Quản lý hồ sơ học sinh', 'Điểm danh', 'Theo dõi học phí', 'Thông báo cho phụ huynh', 'Báo cáo lớp học'] },
      { title: 'Lợi ích', items: ['Giảm giấy tờ thủ công', 'Dữ liệu tập trung', 'Phụ huynh nắm thông tin nhanh', 'Ban giám hiệu dễ theo dõi'] },
    ],
  },
  '/phan-mem/dong-bo-du-lieu-iorder-rpa': {
    ...
    sections: [
      { title: 'Tác vụ có thể tự động hóa', items: ['Đồng bộ sản phẩm', 'Đồng bộ đơn hàng', 'Xuất nhập báo cáo', 'Kiểm tra dữ liệu định kỳ'] },
      { title: 'Giá trị vận hành', items: ['Giảm nhập liệu tay', 'Hạn chế sai sót', 'Tiết kiệm thời gian', 'Dễ mở rộng theo quy trình riêng'] },
    ],
  },
  '/phan-mem/quan-ly-tram-sac-xe-dien': {
    ...
    sections: [
      { title: 'Tính năng chính', items: ['Theo dõi trạng thái trụ sạc', 'Quản lý phiên sạc', 'Thanh toán', 'Báo cáo doanh thu', 'Quản lý người dùng'] },
      { title: 'Mục tiêu', items: ['Vận hành tập trung', 'Giám sát thiết bị tốt hơn', 'Minh bạch doanh thu', 'Hỗ trợ mở rộng nhiều điểm sạc'] },
    ],
  },
  '/phan-mem/quan-ly-van-tai': {
    ...
    sections: [
      { title: 'Nghiệp vụ chính', items: ['Quản lý đơn vận chuyển', 'Theo dõi phương tiện', 'Phân công tài xế', 'Chi phí nhiên liệu và bảo trì', 'Báo cáo chuyến'] },
      { title: 'Lợi ích', items: ['Tối ưu điều phối', 'Kiểm soát chi phí', 'Theo dõi tiến độ', 'Dữ liệu vận hành tập trung'] },
    ],
  },
  '/phan-mem/hoa-don-dien-tu-chu-ky-so': {
    ...
    sections: [
      { title: 'Hỗ trợ triển khai', items: ['Tư vấn gói dịch vụ', 'Hướng dẫn hồ sơ', 'Cài đặt chữ ký số', 'Hỗ trợ phát hành hóa đơn'] },
      { title: 'Phù hợp với', items: ['Hộ kinh doanh', 'Doanh nghiệp nhỏ', 'Chuỗi cửa hàng', 'Đơn vị cần chuẩn hóa chứng từ'] },
    ],
  },
  '/giai-phap/phan-mem': {
    ...
    sections: [
      ...
      },
      {
        ...
        items: ['Tư vấn quy trình trước khi cài đặt', 'Chuẩn hóa danh mục sản phẩm, giá bán và kho', 'Đào tạo nhân viên theo vai trò', 'Báo cáo vận hành theo chi nhánh'],
      },
    ],
  },
  '/giai-phap/phan-mem/ban-hang-doanh-nghiep': {
    ...
    sections: [
      { title: 'Tính năng chính', items: ['Bán hàng POS tại quầy', 'Quản lý tồn kho theo chi nhánh', 'Theo dõi công nợ và khách hàng', 'Báo cáo doanh thu theo ca, ngày, tháng'] },
      { title: 'Phù hợp với', items: ['Cửa hàng bán lẻ', 'Siêu thị mini', 'Chuỗi cửa hàng', 'Doanh nghiệp cần đồng bộ dữ liệu bán hàng'] },
    ],
  },
  '/giai-phap/phan-mem/suc-khoe-lam-dep': {
    ...
    sections: [
      { title: 'Quản lý vận hành', items: ['Lịch hẹn và trạng thái phục vụ', 'Gói dịch vụ và liệu trình', 'Thông tin khách hàng thân thiết', 'Hoa hồng nhân viên tư vấn và kỹ thuật viên'] },
      { title: 'Báo cáo cần có', items: ['Doanh thu theo dịch vụ', 'Tần suất quay lại của khách', 'Hiệu suất nhân viên', 'Tồn kho mỹ phẩm và vật tư'] },
    ],
  },
  '/giai-phap/phan-mem/quan-ly-the-thao': {
    ...
    sections: [
      { title: 'Nghiệp vụ chính', items: ['Quản lý gói hội viên', 'Đặt lịch theo khung giờ', 'Thanh toán và gia hạn gói', 'Theo dõi doanh thu dịch vụ'] },
      { title: 'Mở rộng', items: ['Thông báo lịch tập', 'Quản lý huấn luyện viên', 'Bán hàng tại quầy', 'Báo cáo sử dụng sân/phòng'] },
    ],
  },
  '/giai-phap/phan-mem/an-uong-giai-tri': {
    ...
    sections: [
      { title: 'Tính năng vận hành', items: ['Sơ đồ bàn/phòng', 'Gọi món nhanh', 'In bếp/bar', 'Tách/gộp/chuyển bàn', 'Thanh toán đa phương thức'] },
  ...
  '/giai-phap/ha-tang': {
    ...
    sections: [
      { title: 'Hạng mục triển khai', items: ['Khảo sát hiện trạng', 'Thiết kế sơ đồ mạng', 'Thi công và cấu hình thiết bị', 'Bàn giao tài liệu vận hành'] },
      { title: 'Mục tiêu', items: ['Kết nối ổn định', 'Dễ mở rộng', 'Bảo mật tốt hơn', 'Giảm thời gian gián đoạn dịch vụ'] },
    ],
  },
  '/giai-phap/ha-tang/mang-wifi-camera': {
    ...
    sections: [
      { title: 'Phạm vi', items: ['Thiết kế LAN/Wifi', 'Cấu hình router, switch, access point', 'Lắp đặt camera IP', 'Phân quyền xem camera'] },
      { title: 'Bàn giao', items: ['Sơ đồ kết nối', 'Tài khoản quản trị', 'Hướng dẫn vận hành', 'Lịch bảo trì đề xuất'] },
    ],
  },
  '/giai-phap/ha-tang/can-bang-tai-ha-bao-mat': {
    ...
    sections: [
      { title: 'Giải pháp', items: ['Cân bằng tải nhiều WAN', 'Failover khi mất mạng', 'Firewall và phân vùng mạng', 'VPN truy cập từ xa'] },
  ...
  '/giai-phap/ha-tang/data-center': {
    ...
    sections: [
      ...
      { title: 'Yêu cầu kiểm soát', items: ['Tính sẵn sàng', 'Khả năng mở rộng', 'An toàn dữ liệu', 'Quy trình khôi phục'] },
    ],
  },
  '/giai-phap/ha-tang/may-chu-server': {
    ...
    sections: [
      { title: 'Dịch vụ', items: ['Cài đặt hệ điều hành', 'Cấu hình web/mail/file server', 'Thiết lập proxy', 'Backup và giám sát'] },
  ...
  '/giai-phap/ha-tang/kiem-soat-ra-vao-cham-cong': {
    ...
    sections: [
      { title: 'Tính năng', items: ['Quản lý nhân sự', 'Ghi nhận giờ vào ra', 'Xuất báo cáo chấm công', 'Phân quyền khu vực'] },
  ...
  '/giai-phap/dich-vu-cntt': {
    ...
    sections: [
      { title: 'Nhóm dịch vụ', items: ['Thi công mạng, wifi, camera', 'Bảo trì IT', 'Hosting và website', 'Chữ ký số và hóa đơn điện tử', 'Phát triển phần mềm theo yêu cầu'] },
      { title: 'Cách làm việc', items: ['Tiếp nhận yêu cầu', 'Khảo sát và đề xuất', 'Triển khai', 'Bảo hành và hỗ trợ'] },
    ],
  },
  '/dich-vu/dich-vu-cntt/thi-cong-mang-wifi-camera': {
    ...
    sections: [
      { title: 'Quy trình', items: ['Khảo sát mặt bằng', 'Lập danh sách thiết bị', 'Thi công dây và lắp đặt', 'Cấu hình và kiểm thử'] },
  ...
  '/dich-vu/tich-hop': {
    ...
    sections: [
      { title: 'Kênh tích hợp', items: ['Website bán hàng', 'Sàn thương mại điện tử', 'Phần mềm kế toán', 'CRM', 'Cổng thanh toán'] },
      { title: 'Cách triển khai', items: ['Khảo sát dữ liệu', 'Thiết kế luồng đồng bộ', 'Kiểm thử mẫu', 'Bàn giao và giám sát'] },
    ],
  },
  '/dich-vu/support': {
    ...
    sections: [
      { title: 'Nội dung hỗ trợ', items: ['Cài đặt ban đầu', 'Kết nối máy in', 'Hướng dẫn thao tác', 'Kiểm tra dữ liệu', 'Tư vấn quy trình'] },
  ...
  '/dich-vu/dich-vu-cntt/bao-tri-it': {
    ...
    sections: [
      { title: 'Hạng mục hỗ trợ', items: ['Kiểm tra thiết bị', 'Xử lý lỗi mạng', 'Cài đặt phần mềm', 'Tư vấn nâng cấp'] },
      { title: 'Cam kết vận hành', items: ['Tiếp nhận nhanh', 'Ưu tiên sự cố ảnh hưởng bán hàng', 'Ghi nhận lịch sử xử lý', 'Đề xuất phòng ngừa'] },
    ],
  },
  '/dich-vu/dich-vu-cntt/hosting-website': {
    ...
    sections: [
      { title: 'Gói triển khai', items: ['Đăng ký tên miền', 'Cấu hình hosting', 'Thiết kế giao diện', 'Tối ưu hiển thị mobile'] },
      { title: 'Sau bàn giao', items: ['Hướng dẫn cập nhật nội dung', 'Backup cơ bản', 'Cấu hình email', 'Hỗ trợ kỹ thuật'] },
    ],
  },
  '/dich-vu/dich-vu-cntt/chu-ky-so-hoa-don-dien-tu': {
    ...
    sections: [
      { title: 'Hỗ trợ', items: ['Tư vấn gói phù hợp', 'Hướng dẫn hồ sơ', 'Cài đặt công cụ ký số', 'Hỗ trợ xuất hóa đơn ban đầu'] },
      { title: 'Lợi ích', items: ['Tiết kiệm thời gian', 'Dễ tra cứu', 'Phù hợp quy trình kế toán', 'Hạn chế sai sót thủ công'] },
    ],
  },
  '/dich-vu/dich-vu-cntt/name-card-dien-tu': {
    ...
    sections: [
      { title: 'Nội dung hiển thị', items: ['Thông tin cá nhân hoặc doanh nghiệp', 'Số điện thoại, email, địa chỉ', 'Liên kết website và mạng xã hội', 'QR code chia sẻ nhanh'] },
      { title: 'Phù hợp với', items: ['Nhân sự kinh doanh', 'Chủ doanh nghiệp', 'Đội ngũ tư vấn', 'Thương hiệu cần hồ sơ giới thiệu gọn nhẹ'] },
    ],
  },
  '/dich-vu/dich-vu-cntt/phat-trien-phan-mem': {
    ...
    sections: [
      { title: 'Phạm vi', items: ['Phân tích nghiệp vụ', 'Thiết kế giao diện', 'Phát triển tính năng', 'Tích hợp API', 'Bảo trì sau triển khai'] },
      { title: 'Đầu ra', items: ['Tài liệu yêu cầu', 'Bản demo', 'Mã nguồn hoặc gói triển khai theo thỏa thuận', 'Hướng dẫn sử dụng'] },
    ],
  },
  '/dich-vu/dich-vu-cntt/tu-van-chuyen-doi-so': {
    ...
    sections: [
      { title: 'Nội dung tư vấn', items: ['Rà soát quy trình', 'Xác định điểm nghẽn', 'Đề xuất công cụ', 'Lộ trình triển khai theo giai đoạn'] },
      { title: 'Mục tiêu', items: ['Giảm thao tác thủ công', 'Dữ liệu tập trung', 'Theo dõi hiệu quả tốt hơn', 'Dễ mở rộng khi tăng chi nhánh'] },
    ],
  },
  '/ho-tro/cai-dat': {
    ...
    sections: [
      { title: 'Các bước chính', items: ['Kiểm tra thiết bị', 'Cài đặt ứng dụng', 'Kết nối máy in hóa đơn/bếp', 'Tạo dữ liệu mẫu', 'Chạy thử đơn hàng'] },
  ...
  '/ho-tro/faq': {
    ...
    sections: [
      { title: 'Bắt đầu', items: ['Có thể dùng thử trước khi đăng ký không?', 'Có hỗ trợ nhập dữ liệu ban đầu không?', 'Có dùng được nhiều chi nhánh không?'] },
      { title: 'Vận hành', items: ['Mất mạng có ảnh hưởng bán hàng không?', 'Có kết nối máy in bếp không?', 'Có phân quyền nhân viên không?'] },
    ],
  },
  '/ho-tro/video': {
    ...
    sections: [
      ...
      { title: 'Đang cập nhật', items: ['Video sẽ được bổ sung theo từng nhóm nghiệp vụ', 'Liên hệ hỗ trợ nếu cần hướng dẫn trực tiếp'] },
    ],
  },
  '/huong-dan': {
    ...
    sections: [
      ...
      { title: 'Quản lý', items: ['Tạo sản phẩm', 'Quản lý kho', 'Thêm nhân viên', 'Xem báo cáo', 'Cấu hình chi nhánh'] },
    ],
  },
  '/faq': {
    title: 'FAQ',
    ...
    sections: [
      { title: 'Sản phẩm', items: ['Có phù hợp nhà hàng và bán lẻ không?', 'Có dùng được nhiều thiết bị không?', 'Có báo cáo doanh thu theo thời gian thực không?'] },
      { title: 'Triển khai', items: ['Thời gian cài đặt bao lâu?', 'Có đào tạo nhân viên không?', 'Có hỗ trợ chuyển dữ liệu không?'] },
    ],
  },
  '/ho-tro-tu-xa': {
    title: 'Hỗ trợ từ xa',
    ...
    sections: [
      { title: 'Khi nào cần hỗ trợ từ xa', items: ['Lỗi in hóa đơn', 'Không kết nối thiết bị', 'Cần kiểm tra cấu hình', 'Cần hướng dẫn thao tác nhanh'] },
      { title: 'Thông tin cần cung cấp', items: ['Tên cửa hàng', 'Số điện thoại liên hệ', 'Mô tả lỗi', 'Ảnh chụp màn hình nếu có'] },
    ],
  },
  '/gioi-thieu': {
    title: 'Về iOrder',
    ...
    sections: [
      { title: 'Chúng tôi tin vào vận hành rõ ràng', items: ['Bán hàng nhanh nhưng dữ liệu phải chính xác', 'Quản lý kho phải đi cùng đơn hàng thực tế', 'Báo cáo phải giúp chủ cửa hàng ra quyết định ngay', 'Mở thêm chi nhánh phải có quy trình thống nhất'] },
      { title: 'iOrder đồng hành trong từng ca bán', items: ['POS tại quầy, gọi món, in bếp và thanh toán', 'Tồn kho, khách hàng, nhân viên và phân quyền', 'Báo cáo doanh thu theo thời gian thực', 'Hỗ trợ thiết bị, hạ tầng và triển khai thực tế tại cửa hàng'] },
      { title: 'Dành cho mô hình đang muốn lớn lên', items: ['Nhà hàng, cafe, trà sữa, bán lẻ và chuỗi cửa hàng', 'Chủ kinh doanh cần quản lý từ xa', 'Đội ngũ cần thao tác đơn giản, ít đào tạo', 'Doanh nghiệp cần dữ liệu tập trung để mở rộng'] },
      { title: 'Điều làm iOrder khác biệt', items: ['Không tách rời phần mềm khỏi vận hành thực tế', 'Tập trung vào trải nghiệm nhân viên lẫn góc nhìn quản lý', 'Linh hoạt theo nghiệp vụ từng mô hình', 'Ưu tiên triển khai được, dùng được và đo lường được'] },
    ],
  },
  '/terms': {
    ...
    sections: [
      { title: 'Nguyên tắc sử dụng', items: ['Cung cấp thông tin chính xác', 'Bảo mật tài khoản', 'Sử dụng dịch vụ đúng mục đích', 'Thông báo khi phát hiện sự cố'] },
      { title: 'Hỗ trợ và dữ liệu', items: ['Hỗ trợ trong phạm vi dịch vụ đăng ký', 'Không chia sẻ dữ liệu trái phép', 'Sao lưu theo chính sách từng gói', 'Liên hệ khi cần điều chỉnh thông tin'] },
    ],
  },
  '/tin-tuc/tinh-nang-ban-hang-online-tich-hop': {
    ...
    sections: [
      { title: 'Nội dung chính', items: ['Đồng bộ sản phẩm giữa kênh online và POS', 'Kiểm soát tồn kho khi phát sinh đơn', 'Theo dõi trạng thái xử lý đơn', 'Tổng hợp báo cáo theo kênh bán'] },
      { title: 'Checklist triển khai', items: ['Chuẩn hóa mã sản phẩm', 'Cấu hình kho xuất hàng', 'Quy định quy trình xác nhận đơn', 'Kiểm tra báo cáo sau mỗi ca'] },
    ],
  },
  '/tin-tuc/cach-toi-uu-hoa-doanh-thu-ban-hang': {
    ...
    sections: [
      { title: 'Việc nên làm', items: ['Theo dõi sản phẩm bán chạy', 'Tạo combo phù hợp', 'Nhắc lại khách hàng cũ', 'So sánh doanh thu theo ca và nhân viên'] },
      { title: 'Dữ liệu cần xem', items: ['Doanh thu theo ngày', 'Biên lợi nhuận', 'Tỷ lệ hủy đơn', 'Tồn kho chậm luân chuyển'] },
    ],
  },
  '/tin-tuc/cau-chuyen-khach-hang-mo-rong-chuoi': {
    ...
    sections: [
      { title: 'Nền tảng cần có', items: ['Danh mục sản phẩm dùng chung', 'Báo cáo theo chi nhánh', 'Phân quyền quản lý', 'Đồng bộ kho và giá bán'] },
      { title: 'Rủi ro thường gặp', items: ['Mỗi chi nhánh tự đặt quy trình riêng', 'Không kiểm soát tồn kho', 'Báo cáo chậm', 'Khó đào tạo nhân viên mới'] },
    ],
  },
  '/tin-tuc/cap-nhat-bao-mat-du-lieu': {
    ...
    sections: [
      { title: 'Nguyên tắc bảo mật', items: ['Không dùng chung tài khoản', 'Phân quyền theo vai trò', 'Khóa tài khoản nhân viên nghỉ việc', 'Sao lưu dữ liệu định kỳ'] },
      { title: 'Điểm cần kiểm tra', items: ['Danh sách tài khoản', 'Lịch sử thao tác quan trọng', 'Thiết bị đăng nhập', 'Quy trình đổi mật khẩu'] },
    ],
  },
  '/tin-tuc/ket-noi-iorder-voi-he-thong-hien-tai': {
    ...
    sections: [
      { title: 'Luồng thường tích hợp', items: ['Đơn hàng online về POS', 'Tồn kho từ POS sang website', 'Dữ liệu khách hàng sang CRM', 'Báo cáo sang kế toán'] },
      { title: 'Chuẩn bị trước khi tích hợp', items: ['Mã sản phẩm thống nhất', 'Quy định kho nguồn', 'Tài khoản API', 'Kịch bản kiểm thử'] },
    ],
  },
  '/tin-tuc/phan-mem-pos-tot-nhat-2024': {
    ...
    sections: [
      { title: 'Tiêu chí đánh giá', items: ['Dễ dùng', 'Ổn định khi đông khách', 'Kết nối máy in và thiết bị', 'Báo cáo rõ ràng', 'Hỗ trợ sau bán hàng'] },
      { title: 'Câu hỏi trước khi chọn', items: ['Có phù hợp mô hình của mình không?', 'Có mở rộng nhiều chi nhánh không?', 'Có hỗ trợ nhập dữ liệu ban đầu không?', 'Chi phí duy trì gồm những gì?'] },
    ],
  },
}
      ...
      <main>
        <section className="detail-hero">
          <div className="container">
            ...
            <p className="detail-summary">{page.lead}</p>
          </div>
        </section>
