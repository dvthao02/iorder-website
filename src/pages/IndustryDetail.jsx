...
const hardwarePoints = [
  ...
  { icon: Smartphone, title: 'Quản lý trên nhiều thiết bị', desc: 'Dùng trên máy tính, tablet hoặc điện thoại theo phân quyền.' },
  { icon: Wifi, title: 'Hạ tầng triển khai thực tế', desc: 'Tư vấn wifi, mạng nội bộ, camera và thiết bị tại điểm bán.' },
]
